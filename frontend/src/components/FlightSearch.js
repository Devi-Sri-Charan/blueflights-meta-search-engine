...
function FlightSearch({ onSearchResults, setIsLoading, setError }) {
    ...
    const handleLocationChange = (name, value) => {
        setFormData((prev) => ({
            ...prev,
            [name]: value, // Update formData correctly
        }));
    };
    ...
    const handleSubmit = async (e) => {
        ...
        // Ensure valid IATA codes are present
        ...
        const searchData = { ...formData }; // Copy formData correctly

        if (tripType === "oneWay") {
            delete searchData.returnDate;
        }

        // console.log("Final Search Data:", searchData); // Debugging before API call
                    ...
                    <Row>
                        <Col md={6}>
                            <AirportAutoComplete
                                ...
                                onChange={(event) => handleLocationChange("originLocationCode", event.target.value)} // Extract value correctly
                                required
                            />
                        </Col>
                        <Col md={6}>
                            <AirportAutoComplete
                                label="Destination"
                                placeholder="Enter city or airport"
                                onChange={(event) => handleLocationChange("destinationLocationCode", event.target.value)} // Extract value correctly
                                required
                            />
                        </Col>
                    </Row>
